...
import type { LoadOptionsParams, OptionName, OptionStore, SelectOption } from '../components/FormExampleClientOnboardingPlanner.vue';
import { reactive } from 'vue';
import FormExampleClientOnboardingPlanner from '../components/FormExampleClientOnboardingPlanner.vue';
...
<template>
  <FormExampleClientOnboardingPlanner :option-store="optionStore" @load-options="loadOptions" />
</template>
