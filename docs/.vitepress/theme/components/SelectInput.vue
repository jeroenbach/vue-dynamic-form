...
<template>
  <select
    ...
    class="h-10 w-full rounded-lg border bg-white dark:bg-slate-900 !px-3 !py-2 md:text-sm text-slate-900 dark:text-slate-100 transition-colors focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-50 dark:disabled:bg-slate-800 disabled:text-slate-500 dark:disabled:text-slate-400"
    :class="{
